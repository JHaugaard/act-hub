...
- **What it does:**
  ...
  - Stores all data on your external drive: `/Volumes/dev/develop/act-hub/pocketbase-data`
...
```
/Volumes/dev/develop/act-hub/pocketbase-data/
...
1. Verify external drive path is accessible
   ```bash
   ls /Volumes/dev/develop/act-hub/
   ```
